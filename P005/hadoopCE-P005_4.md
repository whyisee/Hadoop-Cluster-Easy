...
这篇流水账其实都是从<<从Paxos到Zookeeper  分布式一致性原理与实践>> ,这本书中记录下来的, 整本书看下来非常爽,之前一直想了解一些大型项目,想看大型项目的源码,但有一说一,没有踏实的基础源码很难看下去.而这本书,先从原理开始,再结合项目应用,最后深入到zookeeper底层源码,让人从粗到细渐渐理解.语言通俗,让我这个curd工程师都能看懂,给予了我很大的信心继续去研究源码.
